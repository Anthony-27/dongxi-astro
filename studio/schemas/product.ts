...
export const product = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'number',
      description: '面料幅宽。常见：90 / 110 / 114 / 140 / 150 / 160 cm。成衣/辅料可不填。',
      options: { list: [90, 110, 114, 140, 150, 160] },
    }),
    defineField({
      name: 'gsm',
      title: '克重 / GSM (g/m²)',
      type: 'number',
      description: '面料克重（每平方米克数）。系统自动用 GSM × 幅宽 计算运费重量。成衣/辅料不填此项。',
      placeholder: '例如: 真丝薄款 50 / 雪纺 80 / 棉布 180 / 牛仔 350',
      validation: R => R.positive(),
    }),
    defineField({
      name: 'weightPerUnit',
      title: '单件重量含包装 / Weight per unit (kg) — 成衣/辅料专用',
      type: 'number',
      description: '仅成衣和辅料填写。面料请填 GSM + 幅宽，系统自动计算。',
      placeholder: '例如: T恤 0.30 / 外套 0.80 / 拉链 0.05',
      validation: R => R.positive(),
    }),
    defineField({
      name: 'description',
